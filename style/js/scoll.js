...
function ISL_ScrUp_1() {
  if (GetObj("ISL_Cont_11").scrollLeft <= 0) {
    GetObj("ISL_Cont_11").scrollLeft =
      GetObj("ISL_Cont_11").scrollLeft + GetObj("List1_1").offsetWidth;
  }
...
function ISL_StopDown_1() {
  ...
  clearInterval(MoveTimeObj_1);
  if (
    (GetObj("ISL_Cont_11").scrollLeft % PageWidth_1) -
      (fill_1 >= 0 ? fill_1 : fill_1 + 1) !=
    0
  ) {
    Comp_1 =
      PageWidth_1 - (GetObj("ISL_Cont_11").scrollLeft % PageWidth_1) + fill_1;
    CompScr_1();
  } else {
    MoveLock_1 = false;
  }
...
function ISL_ScrDown_1() {
  if (GetObj("ISL_Cont_11").scrollLeft >= GetObj("List1_1").scrollWidth) {
    GetObj("ISL_Cont_11").scrollLeft =
      GetObj("ISL_Cont_11").scrollLeft - GetObj("List1_1").scrollWidth;
  }
  GetObj("ISL_Cont_11").scrollLeft += Space_1;
}
function CompScr_1() {
...
function picrun_ini() {
  ...
  GetObj("ISL_Cont_11").scrollLeft =
    fill_1 >= 0 ? fill_1 : GetObj("List1_1").scrollWidth - Math.abs(fill_1);
